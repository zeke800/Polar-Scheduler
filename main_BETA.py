...
print("[LOG] Starting PyEphem...")
o = ephem.Observer()
o.lat, o.lon = yourLat,yourLon
o.elevation = yourAlt
print("[LOG] Extracting NOAA 15,18 and 19...")

try:
    noaa15line1, noaa15line2, noaa15line3 = helpers.get_tle_lines("NOAA 15 [B]             ")
    noaa18line1, noaa18line2, noaa18line3 = helpers.get_tle_lines("NOAA 18 [B]             ")
    noaa19line1, noaa19line2, noaa19line3 = helpers.get_tle_lines("NOAA 19 [+]             ")
    noaa15 = ephem.readtle(noaa15line1.replace("\n",""), noaa15line2.replace("\n",""), noaa15line3.replace("\n",""));#Because of weird formatting of the TLE
    noaa18 = ephem.readtle(noaa18line1, noaa18line2, noaa18line3);
    noaa19 = ephem.readtle(noaa19line1, noaa19line2, noaa19line3);
except KeyError:
    print("[ERROR] Hmm... since this script was written, it seems like the TLEs changed drastically. Are NOAA 15 and 18 not the backup anymore?")
    time.sleep(2)
    exit()
...
for i in range(len(schedule)):
    ...
    if ((eventType == "Start of GAC transmission") or (eventType == "End of GAC transmission  ")):
        ...
        #t = ts.utc(dateParsed.year, dateParsed.month, dateParsed.day, dateParsed.hour,dateParsed.minute,dateParsed.second)
        ...
        """
        try:
            if math.degrees(el) >= minElevation:
                
                    
                print(dateParsed, satIDParsed, eventType, txFreq, stationParsed, emoji,el)
        ...
        satellite.compute(o)
        el = satellite.alt
        print(dateParsed, satIDParsed, eventType, txFreq, stationParsed, emoji,math.degrees(el))
        """
        if math.degrees(el) >= minElevation:
            print(dateParsed, satIDParsed, eventType, txFreq, stationParsed, emoji,el)
